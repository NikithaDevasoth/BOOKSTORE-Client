    ...
    const fetchCart = async () => {
      try {
        ...
        const response = await axios.get(
          "https://bookstore-server-fuda.onrender.com/carts/get-user-cart",
          { headers }
        );
  ...
  const deleteItem = async (bookId) => {
    try {
      const response = await axios.put(
        `https://bookstore-server-fuda.onrender.com/carts/remove-from-cart/${bookId}`,
        {},
        { headers }
      );
  ...
  const PlaceOrder = async () => {
    try {
      const response = await axios.post(
        `https://bookstore-server-fuda.onrender.com/orders/place-order`,
        { order: Cart },
        { headers }
      );
      alert(response.data.message);
